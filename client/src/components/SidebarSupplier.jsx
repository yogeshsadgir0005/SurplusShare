  ...
  return (
    <aside className="flex flex-col h-full bg-white overflow-hidden w-full shrink-0 relative">
      ...
      <nav className="flex-grow px-3 py-5 sm:px-5 space-y-1 overflow-y-auto [&::-webkit-scrollbar]:hidden">
        ...
        <SidebarItem label="History" path="/supplier/history" icon="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
